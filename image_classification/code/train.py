...
parser = argparse.ArgumentParser(description='Classification for IDML')
...
def main():
    ...
    if args.dataset.startswith('cifar'):
        ...
        traindir = os.path.join('../data/imagenet-1k/train')
        valdir = os.path.join('../data/imagenet-1k/val')
